...
<form action="<?=$_SERVER['PHP_SELF'];?>">
    ...
    <button type="submit" class="btn btn-primary" style="background-color: #df6919; border-color: #df6919;margin-top: 0px;padding-top: 5px;padding-bottom: 5px;"><b>WHOIS</b> <span class="fa fa-search" aria-hidden="true"></span></button> <a href="https://dig.pwned.my.id" class="btn btn-primary" style="background-color: #df6919; border-color: #df6919;margin-top: 0px;padding-top: 5px;padding-bottom: 5px;"><b>DIG</b> <span class="fa fa-globe" aria-hidden="true"></span></a>
    </p>
</form>
</center>
<?php
